...
<style>
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .btn-share{background:#16a34a;color:#fff;border:none;padding:8px 16px;border-radius:8px;cursor:pointer;font-size:12px;font-weight:600;font-family:'Inter',sans-serif;display:inline-flex;align-items:center;gap:6px}
...
<div style="width:100%;max-width:500px">
  <div class="print-bar">
    ...
    <button class="btn-share" id="btnShare" onclick="compartilharPDF()">
  ...
  <div class="doc">
    ...
    <div class="doc-body">
      ...
      <div class="contact-box">
        ...
        <p style="font-size:11.5px;color:#64748b">Dúvidas? Precisa de ajuda? Fale com seu vendedor.</p>
      </div>
...
async function compartilharPDF() {
  ...
  try {
    ...
    const fileName = 'comprovante-${v.reference}.pdf'
    const file = new File([blob], fileName, { type: 'application/pdf' })
    if (navigator.canShare && navigator.canShare({ files: [file] })) {
      await navigator.share({ files: [file], title: 'Comprovante de venda', text: 'Comprovante ${v.reference}' })
    } else {
    ...
    if (e?.name !== 'AbortError') alert('Não foi possível gerar o PDF: ' + e.message)
  } finally {
