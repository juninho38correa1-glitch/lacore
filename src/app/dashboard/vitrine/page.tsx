                  ...
                  <tr key={g.key}>
                    <td>
                      <div className="flex items-center gap-2">
                        {photo ? <img src={photo.url} alt={`${g.brand} ${g.model}`} className="w-9 h-9 rounded-lg object-contain flex-shrink-0" /> : <div className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center flex-shrink-0"><Smartphone size={16} className="text-slate-600" /></div>}
                        <div>
