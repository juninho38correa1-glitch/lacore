                  ...
                  <tr key={g.key}>
                    <td>
                      <div className="flex items-center gap-2">
                        {photo ? <img src={photo.url} className="w-9 h-9 rounded-lg object-cover flex-shrink-0" /> : <div className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-lg flex-shrink-0">📱</div>}
                        <div>
